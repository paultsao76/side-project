			...
			<main>
		        ...
		        <form id="postform">
			   		<table bgcolor="white" class="table table-bordered" style="width: <?=$CFG->width?>;">
			   		  	<thead align="center">
			   		  		<tr>
			   		  			<th class="align-middle" width="2%">pick</th>
			   		  			<th class="align-middle" width="3%">item</th>
			   		  			<th class="align-middle" width="10%">name</th>
			   		  			<th class="align-middle" width="5%">gender</th>
			   		  			<th class="align-middle" width="10%">body shape</th>
			   		  			<th class="align-middle" width="5%">haired</th>
			   		  			<th class="align-middle" width="5%">owner</th>
			   		  			<th class="align-middle">remark</th>
			   		  			<th class="align-middle" width="10%">creat date</th>
			   		  		</tr> 
			   		  	</thead>
			   		  	<tbody align="center">
			   		  	<?
			   		  				...
			   		  				?>
				   		  			    <tr>
				   		  			    	<td class="align-middle">
				   		  			     	...
				   		  			     	<td class="align-middle"><?=gender_show($val['gender'])?></td>
				   		  			   		<td class="align-middle"><?=bs_show($val['body_shape'])?></td>
				   		  			   		<td class="align-middle"><?=haired_show($val['haired'])?></td>
