	...
	<div class="row">	
		...
		<div class="col-10">
			<main>
		        ...
		        <form id="postform">
			   		<table bgcolor="white" class="table table-bordered" style="width: 100%;">
			   		  	<thead align="center">
			   		  		<tr>
			   		  			<th width="2%">pick</th>
			   		  			<th width="3%">item</th>
			   		  				...
			   		  				?>
				   		  			    <tr>
				   		  			    	<td class="align-middle">
				   		  			     	...
				   		  			     	<td class="align-middle"><?=$val['first_name']?></td>
				   		  			   		<td class="align-middle"><?=$val['last_name']?></td>
				   		  			   		<td class="align-middle"><?=$val['phone']?></td>
				   		  			   		<td class="align-middle"><?=$val['email']?></td>
				   		  			   		<td class="align-middle"><?=$val['point']?></td>
